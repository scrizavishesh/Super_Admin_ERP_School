...
const Subscription = () => {
    return (
        <Container>
         ...
         <h5 className='ms-2 margin-minus22'>Subscriptions Report</h5>
       ...
       <thead className=''>
         <tr className='heading-16 '>
           <th className=''>#</th>
           <th>ID</th>
           <th>Price  &nbsp;<img src="./images/Vector (2).svg" alt="" /></th>
           <th>Package  &nbsp;<img src="./images/Vector (2).svg" alt="" /></th>
           <th>Purchase Date  &nbsp;<img src="./images/Vector (2).svg" alt="" /></th>
           <th>Email</th>
           <th>Contact No</th>
       ...
       <tbody>
         <tr className='heading-14' >
           ...
           <td>+91 9999999999</td>
           <td className='font-green'><span>Active</span></td>
           <td>
         ...
         <tr className='heading-14' style={{backgroundColor:'#F2F3F6'}} >
           ...
           <td>xyz12@gmail.com</td>
           <td>+91 9999999999</td>
           <td className='font-red'><span>Deactivate</span></td>
           <td>
           <div class="dropdown my-button-show">
               <button class="btn btn-secondary dropdown-togg my-button-drop heading-14" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                 Action <img src="./images/Vector (3).svg" alt="" />
